      ...
      <div class="body">
         <section class="left-col user-info">
            <div class="profile-avatar">
               <!-- <div class="inner"></div> -->
               <img src="<?php echo base_url('/assets/images/faces/teacher/'.$teachs['profilePic']); ?>" class="inner">
            </div>
            <div class="left-side">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <form class="pt-3" method="post" enctype="multipart/form-data">
                                      <input value="<?php echo $teachs['id']; ?>" class="form-control here" name="pid" readonly type="hidden">
                                       <div class="form-group row">
                                          <label for="username" class="col-4 col-form-label">First Name</label> 
                                          <div class="col-8">
                                             <input value="<?php echo $teachs['first_name']; ?>" name="first_name" class="form-control here myText" readonly type="text">
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-8">
                                             <input value="<?php echo $teachs['last_name']; ?>" name="last_name" class="form-control here myText" type="text" readonly>
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-8">
                                             <input value="<?php echo $teachs['email']; ?>" name="email" class="form-control here myText" type="text" readonly>
                                             <?php echo form_error('email','<p class="text-danger">','</p>'); ?>
                                          </div>
                                       </div>
                                       <div class="form-group row">
                                          <label for="lastname" class="col-4 col-form-label">Profile Picture</label> 
                                          <div class="col-8">
                                             <input  name="userfile" class="form-control here myText" type="file" disabled>
                                             <input type="hidden" name="old"  value="<?php echo $teachs['profilePic']; ?>">
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-8">
                                             <input value="<?php echo $teachs['mobile']; ?>" name="mobile" class="form-control here myText" type="text" readonly>
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                             <div class="form-check">
                                                ...
                                                <input type="radio" class="form-check-input myText" name="gender" id="membershipRadios1" value="male" disabled <?php if($teachs['gender'] == 'male'){ echo "checked"; } ?>> Male <i class="input-helper"></i></label>
                                             </div>
                                          </div>
                                          <div class="col-sm-2">
                                             <div class="form-check">
                                                <label class="form-check-label">
                                                <input type="radio" class="form-check-input myText" name="gender" id="membershipRadios2" value="female" disabled <?php if($teachs['gender'] == 'female'){ echo "checked"; } ?>> Female <i class="input-helper"></i></label>
                                             </div>
                                          </div>
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-2">
                                             <div class="form-check">
                                                <label class="form-check-label">
                                                <input type="radio" class="form-check-input myText" name="mStatus" id="membershipRadios1" value="married" disabled <?php if($teachs['mStatus'] == 'married'){ echo "checked"; } ?>> Married <i class="input-helper"></i></label>
                                             </div>
                                          </div>
                                          <div class="col-sm-2">
                                             <div class="form-check">
                                                <label class="form-check-label">
                                                <input type="radio" class="form-check-input myText" name="mStatus" id="membershipRadios2" value="unmarried" disabled <?php if($teachs['mStatus'] == 'unmarried'){ echo "checked"; } ?>> Unmarried <i class="input-helper"></i></label>
                                             </div>
                                          </div>
                                  ...
                                  <?php  
                                     ...
                                     <form class="pt-3" method="post">
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $teachs['fatherName']; ?>" name="fatherName" class="form-control here1 myText1" readonly type="text">
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $teachs['motherName']; ?>" name="motherName" class="form-control here1 myText1" type="text" readonly>
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $teachs['fatherEmail']; ?>" name="fatherEmail" class="form-control here1 myText1" type="text" readonly>
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $teachs['fatherMobile']; ?>" name="fatherMobile" class="form-control here1 myText1" type="text" readonly>
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $teachs['fatherOccupation']; ?>" name="fatherOccupation" class="form-control here1 myText1" type="text" readonly>
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $teachs['motherOccupation']; ?>" name="motherOccupation" class="form-control here1 myText1" type="text" readonly>
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <textarea cols="40" rows="4" class="form-control here1 myText1" name="address" readonly=""><?php echo $teachs['address']; ?></textarea>
...
<script>
   ...
   function editParent(){
      ...
      $( "input" ).removeClass( "here1" );
      $( "textarea" ).removeClass( "here1" );
   }
