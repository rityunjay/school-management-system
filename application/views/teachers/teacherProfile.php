...
<div class="body">
  <section class="left-col user-info">
    <div class="profile-avatar">
      <!-- <div class="inner"></div> -->
      <img src="<?php echo base_url('/assets/images/faces/'.$teacher['profilePic']); ?>" class="inner">
    </div>
    <div class="left-side">

    <h2 class="card-title mb-0 font-weight-bold mt-2" style="text-transform: capitalize;"><b><?php echo $teacher['first_name']; ?> <?php echo $teacher['last_name']; ?></b></h2>
    <small class="d-block text-muted font-weight-semibold mb-0"><?php echo $teacher['email']; ?></small>
