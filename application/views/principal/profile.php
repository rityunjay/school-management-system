      ...
      <div class="body">
         <section class="left-col user-info">
            <div class="profile-avatar">
               <!-- <div class="inner"></div> -->
               <img src="<?php echo base_url('/assets/images/faces/principal/'.$principal['profilePic']); ?>" class="inner">
            </div>
            <div class="left-side">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <form class="pt-3" method="post" enctype="multipart/form-data">
                                      <input value="<?php echo $principal['id']; ?>" class="form-control here" name="pid" readonly type="hidden">
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-8">
                                             ...
                                             <input type="hidden" name="old"  value="<?php echo $principal['profilePic']; ?>">
                                  ...
                                  <?php  
                                     ...
                                     <form class="pt-3" method="post">
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $principal['fatherName']; ?>" name="fatherName" class="form-control here1 myText1" readonly type="text">
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $principal['motherName']; ?>" name="motherName" class="form-control here1 myText1" type="text" readonly>
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $principal['fatherEmail']; ?>" name="fatherEmail" class="form-control here1 myText1" type="text" readonly>
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $principal['fatherMobile']; ?>" name="fatherMobile" class="form-control here1 myText1" type="text" readonly>
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <div class="col-8">
                                           <input value="<?php echo $principal['fatherOccupation']; ?>" name="fatherOccupation" class="form-control here1 myText1" type="text" readonly>
