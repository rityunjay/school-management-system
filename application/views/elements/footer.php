			<!-- partial:partials/_footer.html -->
          	<footer class="footer">
	            <div class="d-sm-flex justify-content-center justify-content-sm-between">
	            	<span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright &copy; 2011 - <?php echo date("Y") ?> <a href="https://www.grittechnologies.com/" target="_blank">GRIT Technologies</a>. All rights reserved.</span>
