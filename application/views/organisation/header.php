    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex" style="text-transform: uppercase;">Welcome to <?php echo $orgs['orgName'];?>
          </h5>
          <ul class="navbar-nav navbar-nav-right ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle ml-2" src="<?php echo base_url('/assets/images/faces/organisation/'.$orgs['profilePic']); ?>" alt="Profile image"> <span class="font-weight-normal" style="text-transform: uppercase;"> <?php echo $orgs['nickName']; ?> </span></a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-sm rounded-circle" src="<?php echo base_url('/assets/images/faces/organisation/'.$orgs['profilePic']); ?>" alt="Profile image">
                  <p class="mb-1 mt-3" style="text-transform: uppercase;"><?php echo $orgs['nickName']; ?></p>
                  <p class="font-weight-light text-muted mb-0"><?php echo $orgs['email']; ?></p>
                </div>
                <a class="dropdown-item" href="<?php echo base_url('/organisations/profile/'); ?><?php echo $orgs['id']; ?>/"><i class="dropdown-item-icon icon-user text-primary"></i> My Profile </a>
                <a class="dropdown-item"><i class="dropdown-item-icon icon-speech text-primary"></i> Messages</a>
                <a class="dropdown-item"><i class="dropdown-item-icon icon-energy text-primary"></i> Activity</a>
                <a class="dropdown-item"><i class="dropdown-item-icon icon-question text-primary"></i> FAQ</a>
                <a class="dropdown-item" href="<?php echo base_url('organisations/logout'); ?>"><i class="dropdown-item-icon icon-power text-primary"></i>Logout</a>
              </div>
            </li>
          </ul>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="profile-image">
                  <img class="img-xs rounded-circle" src="<?php echo base_url('/assets/images/faces/organisation/'.$orgs['profilePic']); ?>" alt="profile image">
                  <div class="dot-indicator bg-success"></div>
                </div>
                <div class="text-wrapper">
                  <p class="profile-name" style="text-transform: uppercase;"><?php echo $orgs['nickName']; ?></p>
                  <p class="designation" style="text-transform: capitalize;"><?php echo $orgs['orgName']; ?></p>
                </div>
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('/organisations/dashboard/'); ?>">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="classes">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('organisations/manageClass'); ?>"> Manage Class </a></li>
                  <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('organisations/manageSection/'); ?>"> Manage Section </a></li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item nav-category"><span class="nav-link">Students</span></li>
            <li class="nav-item">
              ...
              <div class="collapse" id="posts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('principals/allstudents/'); ?>"> All Students </a></li>
                </ul>
              </div>
            </li>
