          ...
          <ul class="navbar-nav navbar-nav-right ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle ml-2" src="<?php echo base_url('/assets/images/faces/face8.jpg');?>" alt="Profile image"> <span class="font-weight-normal"> <?php echo $member['first_name']; ?> </span></a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <p class="mb-1 mt-3"><?php echo $member['first_name']; ?></p>
                  <p class="font-weight-light text-muted mb-0"><?php echo $member['email']; ?></p>
                </div>
                <a class="dropdown-item" href="<?php echo base_url('/members/profile/'); ?><?php echo $member['id']; ?>"><i class="dropdown-item-icon icon-user text-primary"></i> My Profile </a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="text-wrapper">
                  <p class="profile-name"><?php echo $member['first_name']; ?></p>
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('/members/dashboard/'); ?>">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href=""> Add Pages </a></li>
                </ul>
              </div>
            </li>
