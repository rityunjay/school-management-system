...
class ManageGallery extends CI_Controller { 
                ...
                if($insert){ 
                    if(!empty($_FILES['images']['name'])){ 
                        ...
                        for($i = 0; $i < $filesCount; $i++){ 
                            ...
                            $uploadPath = './assets/uploads/gallery/images/'; 
            ...
            if($delete){ 
                ...
                if(!empty($galleryData['images'])){  
                    foreach($galleryData['images'] as $img){  
                        @unlink('./assets/uploads/gallery/images/'.$img['file_name']);  
                    }  
                }  
    ...
    public function deleteImage(){ 
        ...
        if($this->input->post('id')){ 
            ...
            if($delete){ 
                // Remove files from the server  
                @unlink('assets/uploads/gallery/images/'.$imgData['file_name']);  
                $status = 'ok';  
            } 
        } 
        echo $status;die;  
